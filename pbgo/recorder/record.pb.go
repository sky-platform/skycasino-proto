...
type RoadmapBead struct {
	...
	Shoe        int32                `protobuf:"varint,2,opt,name=shoe,proto3" json:"shoe,omitempty"`
...
func (x *RoadmapBead) GetShoe() int32 {
	if x != nil {
		return x.Shoe
	}
	return 0
...
func (x *RoadmapBead) GetRound() int32 {
	if x != nil {
		return x.Round
	}
	return 0
...
var file_recorder_record_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x73, 0x68, 0x6f, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x6f,
