...
type RoadmapBead struct {
	...
	Medias      map[string]*URLMedia `protobuf:"bytes,8,rep,name=medias,proto3" json:"medias,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *RoadmapBead) GetMedias() map[string]*URLMedia {
	if x != nil {
		return x.Medias
	}
	return nil
...
var file_recorder_record_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x64, 0x69, 0x61, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x72,
	...
	0x06, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x73, 0x12, 0x28, 0x0a, 0x06, 0x62, 0x61, 0x42, 0x65, 0x61,
	...
	0x64, 0x1a, 0x4d, 0x0a, 0x0b, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
...
var file_recorder_record_proto_goTypes = []interface{}{
	...
	nil,                           // 47: recorder.RoadmapBead.MediasEntry
...
var file_recorder_record_proto_depIdxs = []int32{
	...
	47, // 36: recorder.RoadmapBead.medias:type_name -> recorder.RoadmapBead.MediasEntry
	...
	7,  // 65: recorder.RoadmapBead.MediasEntry.value:type_name -> recorder.URLMedia
